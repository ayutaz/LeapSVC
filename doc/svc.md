...
確認できましたが、**8〜12 時間の学習**になります（見積もり $1.5〜2.5）。**残った弱点は
「未知話者への転移」に絞られており**、案 A の改善が最初の 2,500 step でほぼ終わったことから
**base 側が頭打ちの原因**という仮説です（[実行計画](svc-plan.md#2b-ここからの計画) の②）。
- **target 類似を主観でも測るか**（**要ユーザー判断**）。実施した blind は
