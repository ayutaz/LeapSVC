...
**blind listening test（N=1 の非公式 preference、26 ペア）でも Seed-VC が選ばれました**（25 判定中 21、引き分け 1）。**差は未知 source に集中**し（20 ペアで 2 対 18）、**target 本人の hold-out では拮抗**します（6 ペアで 2 対 3・引き分け 1）。**リアルタイム student は未実施です。**
